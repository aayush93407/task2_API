...
const App = () => {
  ...
  const handleProject1Click = async () => {
    try {
      ...
      alert(`Smart Battery Info: ${JSON.stringify(response.data)}`);
    } catch (error) {
  ...
  const handleProject2Click = async () => {
    try {
      ...
      alert(`Battery Swapping Info: ${JSON.stringify(response.data)}`);
    } catch (error) {
  ...
  const handleProject3Click = async () => {
    try {
      ...
      alert(`Fuel Replacement Info: ${JSON.stringify(response.data)}`);
    } catch (error) {
